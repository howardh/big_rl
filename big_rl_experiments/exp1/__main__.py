...
def plot_results(output_dir, eval_results_dir, eval_random_results_dir, eval_training_task_results_dir):
    ...
    row_headings = sorted(random_performance.keys())
    col_headings = ['', 'Random', 'Single Task']
    table_data = [[task_name, random_performance[task_name], single_task_performance[task_name]] for task_name in row_headings]
